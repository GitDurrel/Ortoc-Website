...
.idees-sejours-hero {
    position: relative;
    min-height: 60vh;
    background: url('https://tourismeouestcameroun.com/wp-content/uploads/2023/05/10-Tagidor-1-scaled.jpg') center/cover no-repeat;
    display: flex;
...
.idees-sejours-hero::before {
    content: '';
    position: absolute;
    inset: 0;
    background: linear-gradient(120deg, rgba(12,65,120,0.7) 0%, rgba(0,0,0,0.5) 100%);
    z-index: 1;
}
