			...
			<div class="footer_bottom row">
				...
				<div class="fb_right displayflex">
					...
					<ul class="rslink nostyle displayflex">
						<li><a href="https://www.facebook.com/share/1CkcdPKmt5/?mibextid=wwXIfr" title="facebook" target="_blank"><img alt="facebook" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/facebook.svg')"></a></li>
					...
					<div class="phone_footer">
						<a href="tel:+237 697 68 74 41"> Appelez-Nous Maintenant</a>
					</div>
				</div>
			</div>
		</div>
